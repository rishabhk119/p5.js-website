...
If you are looking to contribute outside of the p5.js repositories (writing tutorials, planning classes, organizing events), please have a look at the other relevant pages instead. Stewards or maintainers may find the [steward guidelines](../steward_guidelines/) more helpful regarding reviewing issues and pull requests.
...
If you are going to work on unit tests, please see [here](../unit_testing/). Note that for any feature enhancement, new features, and certain bug fix, unit tests covering the new implementations should be included in the PR.
...
If you are going to work on accessibility features, please see [here](../web_accessibility/). For a Friendly Error System, please see [here](../friendly_error_system/).
